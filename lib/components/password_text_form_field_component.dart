...
class _DefaultPasswordTextFieldState extends State<PasswordTextFormFieldComponent> {
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: GestureDetector(
                ...
                child: _fieldVisibility
                    ? SvgPicture.asset(Assets.icons.visibilityEyeOffIcon)
                    : SvgPicture.asset(Assets.icons.visibleEyeIcon)),
          ),
        ),
      ),
    );
