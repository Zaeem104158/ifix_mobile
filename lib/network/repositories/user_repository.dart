...
//   }
// //Get user repository
//   void getUserMeAPI(String url,
//       ResponseCallback<UserMeResponse?, String?> callback) {
//     _apiClient.getRequest(url, (response, error) {
//       if (response != null) {
//         if(response == null || response.toString().isEmpty) {
//           callback(UserMeResponse(), null);
//         } else {
...
//   void updateUserMeAPI(url,Map<String, dynamic> request, ResponseCallback<UpdateProfileResponse?, String?> callback) {
